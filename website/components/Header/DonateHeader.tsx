...
function DonateHeader() {
    return (
            ...
            <div className="relative flex items-center gap-2 mb-2 md:mb-0 animate-fade-in-left sm:text-xs w-full md:w-auto">
                <div className="block md:hidden w-full overflow-x-hidden">
                    <div className="whitespace-nowrap animate-marquee text-center w-max">
                        Stand Up. Give Back. Beat Cancer. <span className="underline">www.ecan.org.sz/donate</span>
                    </div>
                </div>
                <>
                    <p className="text-sm whitespace-nowrap  hidden md:block">Stand Up. Give Back. Beat Cancer.</p>
                    <p className="text-sm underline cursor-pointer whitespace-nowrap animate-reveal hidden md:block">www.ecan.org.sz/donate</p>
                </>
            </div>
        ...
        .animate-reveal { animation: reveal 1.2s 0.5s both; }
        .animate-marquee {
